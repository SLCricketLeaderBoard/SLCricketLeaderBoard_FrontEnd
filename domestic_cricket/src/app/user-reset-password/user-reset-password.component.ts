...
export class UserResetPasswordComponent implements OnInit {
  ...
  resetPassword() {
    ...
    const updatedUser: UserModel = new UserModel(this.user.userId, this.user.userName, this.user.fullName, this.user.nameWithInitial, this.user.nic, this.user.contactNumber, this.user.role, this.user.email, password, this.user.address, this.user.regDate, 1, this.user.profileImage);
