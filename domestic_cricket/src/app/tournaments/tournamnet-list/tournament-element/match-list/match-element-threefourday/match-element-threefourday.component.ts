...
@Component({
  selector: 'app-match-element-threefourday',
  templateUrl: './match-element-threefourday.component.html',
  styleUrls: ['./match-element-threefourday.component.scss']
})
export class MatchElementThreefourdayComponent implements OnInit {
